...
%% 开始书写前请阅读本文及注释了解本模板自定义的相关命令！！

\documentclass[master,pdf]{chinathesis}
% [doctor|master|profmaster(专硕）|bachelor] 选择学位模板，默认博士
% [chinese|english] 选择中英文模板，默认中文
% [print|pdf] 选择版式，默认为print
% [defense] 封面下方增加答辩委员会人员
...
% \secretlevel{内部}        % 绝密|机密|秘密|内部，注释本行则不保密
% \secretyear{2}           % 保密年限
...
\usepackage{amsthm}
\usepackage{pdfpages}
\usepackage[ruled,vlined]{algorithm2e}  % 也可使用minted宏包输入伪代码
